...
public class ActivityCreateQr extends AppCompatActivity {

    public final static int QRcodeWidth = 500 ;
    private static final String IMAGE_DIRECTORY = "/QRGenerados";
    Bitmap bitmap ;
            ...
            public void onClick(View v)
            {
                if(etqr.getText().toString().trim().length() == 0)
                {
                    ...
                    try {
                        ...
                        Toast.makeText(getApplicationContext(), "QRCode saved to -> "+path, Toast.LENGTH_LONG).show();
