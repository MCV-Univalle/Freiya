...
public final class BarcodeCaptureActivity extends AppCompatActivity
    ...
    ArrayList<String> idQuestions;
    Integer classActivityId;
    String codeQr;
    Integer points = 0;
    ...
    public void onCreate(Bundle icicle) {
        ...
        idQuestions = new ArrayList<String>();
        Bundle parametros = this.getIntent().getExtras();

        if(parametros != null)
        {
            idQuestions = parametros.getStringArrayList("idQuestion");
    ...
    public void onDetectedQrCode(Barcode barcode) {
        if (barcode != null)
        {
            switch (classActivityId)
            {
                case 1:
                    Intent intent = new Intent(getApplicationContext(), ActivityShowQuestion.class);
                    intent.putStringArrayListExtra("idQuestion", idQuestions);
                    codeQr = barcode.displayValue;
                    intent.putExtra("codigoQr", codeQr);
